...
- **Blindagem .env:** O arquivo de senhas é carregado apenas em memória e nunca é versionado.
...
Se você estiver atualizando de uma versão anterior, DELETE o arquivo loterias_caixa.db para que o sistema crie as novas tabelas de segurança e grave o novo usuário Administrador com segurança. Após isso, inicie o sistema:
